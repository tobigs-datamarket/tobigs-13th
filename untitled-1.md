...
1주차 전처리와 EDA 강의 과제로 진행되었던 전처리와 EDA 튜토리얼 입니다.
...
{% embed url="https://dacon.io/competitions/official/17801/data?join=0" %}
...
{% file src=".gitbook/assets/eda\_13.ipynb" caption="Python을 이용한 전처리와 시각화" %}
